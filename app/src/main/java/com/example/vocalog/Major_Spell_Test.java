...
public class Major_Spell_Test extends AppCompatActivity {

    private TextView wordTextView;
    private Button nextButton;
    private String[] words = {"전공", "물", "불", "개", "고양이"};
    private String[] spell = {"major","water","fire","dog","cat"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_major_spell_test);
